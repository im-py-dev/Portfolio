...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-[55rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[22rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-[1.9rem] group-even:sm:pr-[0rem] sm:pt-5 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[27rem]">
        ...
        <Image
          ...
          quality={95}
          className="absolute hidden sm:block top-[4.35rem] -right-[1rem] w-[30rem] rounded-t-lg shadow-2xl
        transition 
